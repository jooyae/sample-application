...
object AndroidX {
    ...
    const val CONSTRAINT_LAYOUT ="androidx.constraintlayout:constraintlayout:${DependencyVersions.CONSTRAINT_LAYOUT_VERSION}"
    ...
    object Paging {
        const val PAGING = "androidx.paging:paging-runtime:${DependencyVersions.PAGING_VERSION}"
        const val PAGING_RXJAVA3 = "androidx.paging:paging-rxjava3:${DependencyVersions.PAGING_VERSION}"
    }
...
object Lorem {
    const val LOREM_IPSUM = "com.thedeanda:lorem:${DependencyVersions.LOREM_VERSION}"
}
...
object Paging3{
    const val Paging3 = "androidx.paging:paging-runtime:${DependencyVersions.PAGING_VERSION}"
}
